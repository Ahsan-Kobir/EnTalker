package com.helloenglish.randomcaller.WebRTC.AudioManagerHelpers;
...
/* This class codes was imported from AppRTC demo app */
...
public class RTCAudioManager {
    ...
    private static final String WAKELOG_PROXIMITY_TAG = "wakelog_proximity";
    ...
    private void onProximitySensorChangedState() {
        Log.d("SensorChangedState", String.valueOf(proximitySensor.sensorReportsNearState()));

        if(!selectedAudioDevice.equals(AudioDevice.EARPIECE)){
            return;
        }
    ...
    // Written by: Ahsan Kabir
    // My customized code here

    @SuppressLint("InvalidWakeLockTag")
    private void turnScreenOff() {
        Log.d("ScreenOff", "Screen off called");
        if (powerManager == null) {
            powerManager = (PowerManager) apprtcContext.getSystemService(Context.POWER_SERVICE);
        }
        if (wakeLock == null) {
            wakeLock = powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, WAKELOG_PROXIMITY_TAG);
        }
    ...
    private void initWindowManager() {
        windowManager = (WindowManager) apprtcContext.getSystemService(apprtcContext.WINDOW_SERVICE);
    ...
    // End of my customization of this class
